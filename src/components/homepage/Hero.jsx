    ...
    <>
        <div className="row align-items-center ps-md-5 py-5 mt-5 hero-div">
            <div className="col-lg-6 col-xl-5 col-12 text-lg-start text-center mt-md-5 mt-1">
                ...
                <a className="primary-button btn px-5 py-2 d-none d-lg-inline-block me-2" href='http://employee-directory-dashboard.s3-website.eu-central-1.amazonaws.com/' rel="noreferrer" target='_blank'>Dashboard</a>
            ...
            <div className="d-lg-none col-12 text-center">
                ...
                <a className="primary-button btn px-5 py-2 d-lg-none m-2" href='http://employee-directory-dashboard.s3-website.eu-central-1.amazonaws.com/' rel="noreferrer" target='_blank'>Dashboard</a>
